...
Напишите функцию `fibonacci()`, которая возвращает n-ый элемент последовательности Фиббоначи из положительных чисел. В случае если `n < 0`, функция должна вернуть значение `nil`.
